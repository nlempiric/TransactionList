...
const url =
  "wss://eth-mainnet.g.alchemy.com/v2/_IvJAwz5918sXFFyUXLijVu-0MTVOQ_W";
    ...
    try {
      ...
      if (transaction.to.toLowerCase() === uniswapRouterAddress.toLowerCase()) {
        ...
        if (
          ...
          decodedData.name == "exactOutputSingle"
        ) {
          ...
          console.log(
            "AmountOutMinimum===",
            Number(params.amountOutMinimum._hex)
          );
          console.log(
            "SqrtPriceLimitX96===",
            Number(params.sqrtPriceLimitX96._hex)
          );
          console.log(
            "\n+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n"
          );
